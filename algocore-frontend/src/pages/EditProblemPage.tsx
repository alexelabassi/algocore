...
import { ProblemDifficulty, SchoolGrade, TestCaseRequestDto, ProblemDetailsDto } from '../types';
...
const EditProblemPage: React.FC = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        setFormData({
          ...
          grade: problemData.schoolGrade,
          templateCode: '' // Note: templateCode is not in ProblemDetailsDto, would need backend update
        });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // For now, we'll just update the test cases since the backend doesn't have update problem endpoint
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">Update problem details and test cases</p>
        </div>
